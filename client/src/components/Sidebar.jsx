    ...
    >
      <div className="p-4 flex-1 flex flex-col gap-2">
        ...
        <div className="mt-6 flex flex-col gap-1">
          ...
          <button className="flex items-center gap-3 w-full p-2.5 rounded-lg text-gray-300 hover:bg-gray-800 hover:text-white transition-colors bg-gray-900/50">
      ...
      <button
        ...
        className="absolute -right-3 top-6 bg-gray-800 border border-gray-700 text-gray-300 p-1 rounded-full hover:text-white hover:bg-gray-700 transition-colors z-10"
      >
