  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col gap-4">
      <div className="flex items-center justify-between mb-2">
        ...
        {error && (
          <div className="flex items-center gap-1.5 text-sm text-red-400 animate-in fade-in slide-in-from-top-1">
            <AlertCircle size={16} />
            <span>{error}</span>
          </div>
        )}
      ...
      <div className="relative group">
        ...
        <div className={`relative bg-gray-900 border ${error ? 'border-red-500/50' : 'border-gray-800'} rounded-2xl overflow-hidden focus-within:border-gray-600 transition-colors`}>
          <textarea 
            value={prompt}
            onChange={(e) => {
            ...
            disabled={isLoading}
            className="w-full h-32 bg-transparent text-gray-200 p-4 resize-none focus:outline-none text-base placeholder-gray-500 disabled:opacity-50"
