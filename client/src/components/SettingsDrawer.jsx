    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white tracking-tight">Settings</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 flex items-center justify-center border border-gray-200 dark:border-gray-700 shrink-0">
          ...
          <section>
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-xl bg-red-50 dark:bg-red-500/5 border border-red-200 dark:border-red-500/15 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/10 hover:border-red-300 dark:hover:border-red-500/25 hover:text-red-700 dark:hover:text-red-300 transition-colors text-sm font-medium"
            >
